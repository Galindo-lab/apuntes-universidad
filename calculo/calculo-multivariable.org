...
\[
d = \frac{|Ax_1+By_2+C|}{\sqrt{A^2+B^2}}
\]

*** Ejemplo De La Distancia
Calcular la distacia entre la funcion de \(\frac{-12}{5}x+-4=0\) y el punto \(M:(2,1)\):

\[ \begin{aligned}
& \frac{|-12/5 \cdot 2+1 \cdot 1+(-4)|}{\sqrt{(-12/5)^2+1^2}} \\
& \frac{|-24/5 + 1-4|}{\sqrt{144/25+1}} \\
& \frac{39/5}{\sqrt{169/25}} = \boxed{3}\
\end{aligned} \]
...
** TODO Ecuación Del Plano Que Pasa Por Un Punto Y Es Perpendicular Otro Plano
** TODO Angulos Entre Planos
** TODO Distancia De Un Punto A Una Recta En El Espacio
