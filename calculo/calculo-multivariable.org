...
Una de las cosas que tenemos que notar es como tenemos una función para cada eje coordenado[fn:extensión], si lo graficamos notaremos que si 't' es igual a '0' el valor que obtendremos es igual a P_0, pero si el valor de 't' es '1' el valor que obtenemos será igual a P_1.


[fn:extensión] La fórmula anterior se puede extender a R^3.
...
- [[https://www.wolframalpha.com/widgets/view.jsp?id=537159240ca725f712f6c7437d2f3e0c][Máximos y mínimos]]
...
- [[https://personales.unican.es/alvareze/CalculoWeb/CalculoII/apuntes/curvasParametricas.pdf][Parametrización]]
- [[https://blog.unitips.mx/dominio-y-rango-de-funciones][Rango de una función]]
