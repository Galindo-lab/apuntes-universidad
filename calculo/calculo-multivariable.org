...
La forma mas común de representar la recta es como una igualdad de sus variables con '0':
...
#+attr_latex: :width 4cm
#+caption: \( (x,y) = (1,2) + t(2,2) \)
[[file:svg/ecuacion-vectorial.svg]]

Es importante notar que el valor de 't' es un rango entre [0,1], donde '0' es el valor de el punto 'P_0', y '1' es el extremo de \(\vec{V}\).
