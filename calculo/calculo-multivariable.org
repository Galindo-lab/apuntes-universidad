...
* Integrales De Multiples Variables
** Integrales Dobles
...
\[
\underbrace{ \int \overbrace{ \int f(x,y) \,dx }^\text{Primera Integral} \,dy}_\text{Segunda Integral}
\]
...
\[ \begin{aligned}
& \int_0^5 \int_0^x 1 \,dy \,dx = \boxed{12.5 u^2} \\
\end{aligned} \]
