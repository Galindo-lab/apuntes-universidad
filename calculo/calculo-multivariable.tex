...
\label{sec:org3d8d5c0}
\subsection{Eje coordenado}
\label{sec:org5f6fd17}
...
\textbf{Importante II}: el ángulo \(\theta\) (theta) \textbf{Si} ocupa \hyperref[tab:org6250464]{corrección}.

\noindent\rule{\textwidth}{0.5pt}

\subsection{Polares a rectangulares}
\label{sec:orgc30d03d}
...
\label{sec:org868bee1}
\subsection{Vector Unitario}
\label{sec:org7562c59}
...
\caption{\(V=\vec{a}\cdot(\vec{b}\times\vec{c})\)}
\end{figure}

\[
V= [\vec{a},\vec{b},\vec{c}] =\det\begin{pmatrix}
  a_x & a_y & a_z \\
  b_x & b_y & b_z \\
  c_x & c_y & c_z \\
\end{pmatrix}
