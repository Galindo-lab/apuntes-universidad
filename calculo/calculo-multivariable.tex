...
\label{sec:org86a3527}
\subsection{Eje coordenado}
\label{sec:org9a69ea6}
...
\textbf{Importante II}: el ángulo \(\theta\) (theta) \textbf{Si} ocupa \hyperref[tab:org5c1b660]{corrección}.

\noindent\rule{\textwidth}{0.5pt}

\subsection{Polares a rectangulares}
\label{sec:orgcecc71b}
...
\label{sec:org5ef78c2}
\subsection{Vector Unitario}
\label{sec:org31b1b4d}
