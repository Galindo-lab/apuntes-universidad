...
\label{sec:org53d5393}
\subsection{Eje coordenado}
\label{sec:org7e3fae9}
...
\textbf{Importante II}: el ángulo \(\theta\) (theta) \textbf{Si} ocupa \hyperref[tab:orgcceb765]{corrección}.

\noindent\rule{\textwidth}{0.5pt}

\subsection{Polares a rectangulares}
\label{sec:orgf1ff691}
...
\label{sec:org3054cd0}
\subsection{Vector Unitario}
\label{sec:orgbd5efff}
