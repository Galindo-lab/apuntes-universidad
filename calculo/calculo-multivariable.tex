...
\label{sec:org8bda133}
\subsection{Eje coordenado}
\label{sec:org1c2f6e9}
...
\textbf{Importante II}: el ángulo \(\theta\) (theta) \textbf{Si} ocupa \hyperref[tab:org49917c7]{corrección}.

\noindent\rule{\textwidth}{0.5pt}

\subsection{Polares a rectangulares}
\label{sec:org6aa5e68}
