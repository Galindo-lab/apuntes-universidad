...
\label{sec:orga0a568f}
\subsection{Eje coordenado}
\label{sec:org27e24c2}
...
\textbf{Importante II}: el ángulo \(\theta\) (theta) \textbf{Si} ocupa \hyperref[tab:orgc7840f0]{corrección}.

\noindent\rule{\textwidth}{0.5pt}

\subsection{Polares a rectangulares}
\label{sec:orge3f4046}
...
\label{sec:org3e5046e}
\subsection{Vector Unitario}
\label{sec:orgf781d04}
