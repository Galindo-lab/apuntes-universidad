...
\label{sec:org217b8d3}
\subsection{Eje coordenado}
\label{sec:org649d1f1}
...
\item El ángulo \(\theta\) (theta) \textbf{Si} ocupa \hyperref[tab:org3fcd8c7]{corrección}.
\end{enumerate}
\end{itemize}
...
\label{sec:orgb4e101c}
\subsection{Vector Unitario}
\label{sec:org4636add}
